...
public class Info {
	...
	static public int h_pageCache = 5;
	static public int w_pageCache =5;
	static int h_pixel_pageCache = num_y_Pixel*h_pageCache;
	static int w_pixel_pageCache =num_y_Pixel*w_pageCache;
	
	static int pageTableSize=h_pageCache*w_pageCache;
	
	static public int numLevels=6;
